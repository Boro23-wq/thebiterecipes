    ...
    <div className="relative grid min-h-screen grid-cols-1 lg:grid-cols-2">
      ...
      <div className="flex items-center justify-center bg-[#FAFAFA] px-6 py-12">
        <SignUp.Root>
          ...
          <SignUp.Step name="start" className="w-full max-w-105">
            <motion.div
              initial="hidden"
              animate="show"
            ...
            >
              ...
              {/* <motion.p
                variants={fadeUp}
                custom={6}
                className="mt-5 text-center text-[11px] leading-relaxed text-[#9CA3AF]"
              >
          ...
          <SignUp.Step name="verifications" className="w-full max-w-105">
            <motion.div
              initial="hidden"
              animate="show"
              className="rounded-sm border border-[#EBEBEB] bg-white p-8 shadow-[0_1px_2px_rgba(0,0,0,0.02)]"
